...
from ambidose.io import _as_int_csr, read_10x_barcodes, write_10x_mtx
...
def test_write_10x_mtx_genes_tsv_uses_gene_ids(tmp_path):
...
def test_write_10x_mtx_genes_tsv_without_gene_ids_repeats_symbol(tmp_path):
